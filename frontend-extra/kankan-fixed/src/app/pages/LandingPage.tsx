...
import { Github, ExternalLink, GitBranch, Layers, Shield, Zap } from "lucide-react";
    ...
    <div className="min-h-screen bg-white">
      ...
      <header className="border-b border-gray-100 sticky top-0 bg-white/95 backdrop-blur z-10">
        <div className="container mx-auto px-6 py-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <img src={logo} alt="Boardly" className="h-8" />
            <span className="font-bold text-gray-900 text-lg">Boardly</span>
      ...
      <section className="bg-gray-50 border-y border-gray-100 py-12">
        <div className="container mx-auto px-6 text-center">
          ...
          <div className="flex items-center justify-center gap-8 flex-wrap text-gray-700 font-semibold">
            {["Java 21", "Spring Boot 4", "Spring Security", "JWT", "PostgreSQL", "React", "TypeScript", "Docker"].map(t => (
      ...
      <section className="bg-[#0052CC] py-20">
        <div className="container mx-auto px-6 text-center text-white">
          ...
          <div className="flex items-center justify-center gap-4 flex-wrap">
            <Link to="/about">
              <Button size="lg" className="bg-white text-[#0052CC] hover:bg-gray-100 gap-2">
        ...
        <div className="container mx-auto px-6 flex items-center justify-between flex-wrap gap-4">
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm text-gray-500">
              Made with ♥ by{" "}
              <a href="https://www.linkedin.com/in/oezcanyildiz" target="_blank" className="text-[#0052CC] hover:underline font-medium">
                Ozcan Yildiz
              </a>
            </span>
          </div>
