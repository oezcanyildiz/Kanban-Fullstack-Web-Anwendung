        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          ...
          <div className="bg-white rounded-xl border border-gray-100 shadow-sm p-6">
            ...
            <div className="space-y-3">
              {[
                { label: "Backend", value: "Java 21, Spring Boot 4, Spring Security, Hibernate/JPA" },
            ...
            <div className="border border-gray-100 rounded-xl p-5 hover:border-[#0052CC] transition-colors">
              <div className="flex items-start justify-between flex-wrap gap-3">
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-1">Fullstack · Java 21 · Spring Boot 4 · React · PostgreSQL · Docker</p>
                </div>
