...
export function RegisterPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Nach der Registrierung leiten wir normalerweise zum Login weiter
      // oder loggen den User direkt ein, falls das Backend ein Token sendet.
      navigate("/login");
    } catch (error: any) {
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button type="submit" disabled={!passwordValid || loading}
